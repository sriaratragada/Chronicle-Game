...
In short: AI is positioned as both **character intelligence** and **world intelligence**.
...
3. event-to-quest generation pipelines,
4. narrative quality controls for AI outputs (consistency, lore adherence, safety),
5. optional cloud-backed persistence for long-running worlds.
